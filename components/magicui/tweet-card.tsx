...
export const TweetBody = ({ tweet }: { tweet: EnrichedTweet }) => (
  <div className="break-words font-inter leading-normal tracking-tighter">
...
export const TweetMedia = ({ tweet }: { tweet: EnrichedTweet }) => {
  ...
  return (
    <div className="flex flex-1 items-center justify-center">
      ...
      {tweet.photos && (
        <div className="relative flex transform-gpu snap-x snap-mandatory w-full gap-4 overflow-x-auto">
