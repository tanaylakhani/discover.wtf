    ...
    <>
      <AnimatePresence>
        ...
        <motion.div
          ...
          className={cn(
            "bottom-0 fixed z-50 border-t-2 border-dashed border-orange-300 bg-orange-100 text-neutral-900  backdrop-blur-md px-6 py-2  inset-x-0 right-0 left-0 shadow-xl flex items-center justify-center"
          )}
        >
