...
export default function DiscoverWTFLanding() {
  ...
  return (
    ...
    >
      <div className="border relative md:min-h-[120vh] w-full border-neutral-100 pb-20 overflow-clip rounded-xl ">
        <Hero />
        <Image
      ...
      >
        ...
        <div
          ...
          className={cn(
            "w-full h-[calc(100vh-20px)] sticky rounded-3xl top-2 bottom-2 flex items-center justify-center ",
