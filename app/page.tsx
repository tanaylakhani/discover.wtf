...
export default function DiscoverWTFLanding() {
  ...
  return (
    <motion.div
      ...
      className={cn("min-h-screen w-full max-w-screen-2xl mx-auto relative ")}
    >
      <div className="border relative md:min-h-[800px] w-full border-neutral-100 pb-20 overflow-clip rounded-xl ">
        <Hero />
        <Image
          src="/woods3.jpeg"
          ...
          fill
          quality={100}
          className="opacity-100 object-cover mix-blend-multiply -top-20 z-[3] absolute inset-0 "
          priority
        />
      </div>
      <Navbar hide={false} />
...

{
  /* <section
            ref={ref}
            className="w-full flex flex-col-reverse max-w-5xl mx-auto md:flex-row py-[100px] relative items-start justify-center h-[2000px]"
          >
            <div className=" mt-[60px] w-full h-[800px] flex items-center justify-center ">
            ...
            <div
              ...
              className={cn(
                "w-full h-[600px] sticky rounded-3xl top-2 flex items-center justify-center ",
                ...
                {activeText === 1 && (
                  <div className="w-full h-full flex items-center justify-center relative overflow-hidden">
                    <motion.video
                      ...
                      exit={{ y: 200 }}
                      src="/asset.mp4"
                      className="border-[12px] -bottom-20 border-black max-w-xs w-full absolute  mx-auto rounded-[3rem] aspect-[9/16] object-cover "
                      autoPlay
                      muted
                      loop
                    />
                ...
                {activeText === 3 && (
                  <div className="w-full h-full flex items-center justify-center relative overflow-hidden">
                    ...
                    >
                      <Image
                        src="/asset2.png"
                        alt="Discovery feature illustration"
                        width={400}
                        height={300}
                      />
                    </motion.div>
